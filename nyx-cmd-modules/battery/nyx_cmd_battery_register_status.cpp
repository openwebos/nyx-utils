...
static string descriptionStr = "Registers to device battery status changes and invokes callback.";
int cb_fired = 0;
...
*/
int NyxCmdBatteryRegisterStatus::Execute(const char *deviceId, int argc, char **argv)
{
