...
string NyxCmdSystem::Usage()
{
	const char *const usage =
	    ...
	    "  set_alarm [ALARM_OPTION] TIME   TIME is the absolute time to set the alarm for\n"
	    "                                  Takes alarm time (in \"Mar 01 2013 10:00:00\" format) as an argument.\n"
	    "                                  If 0, any existing RTC alarm present will be cleared\n"
	    "                                  If the TIME set is for a past time, alarm gets fired after 2 seconds.\n"
